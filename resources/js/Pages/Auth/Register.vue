<template>
    <div class="flex">
        <jet-authentication-card class="bg-gradient-to-r from-red-600 to-yellow-300 h-full w-full">
            ...
            <form @submit.prevent="submit" class="mx-6 py-4 text-sm">
                <div>
                ...
                <div class="flex items-center justify-end mt-4">
                    ...
                    <jet-button class="ml-4 bg-gradient-to-r from-red-600 to-yellow-300 border-none rounded-xl text-xs" :class="{ 'opacity-25': form.processing }" :disabled="form.processing">
                        Register
                    </jet-button>
                </div>
            </form>
